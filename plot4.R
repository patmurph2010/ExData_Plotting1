plot4 <- function() {
  ...
  plot(epc_dates[, "Voltage"],type = "l", ylab = "Voltage", xlab = "datetime", xaxt = "n")
  axis(1, point_vector, text_vector)
  ...
  axis(1, point_vector, text_vector)
  plot(epc_dates[, "Global_reactive_power"],type = "l", ylab = "Global_reactive_power", xlab = "datetime", xaxt = "n")
  axis(1, point_vector, text_vector)
  stat <- dev.off()
}